...
const AboutPage = () => {
  ...
  const instagramVideos = [
    {
      id: 'DJdFQH3NOI0',
      url: 'https://www.instagram.com/reel/DJdFQH3NOI0/',
      embedUrl: 'https://www.instagram.com/reel/DJdFQH3NOI0/embed'
    },
    {
      id: 'DJc6c9xtVqK',
      url: 'https://www.instagram.com/reel/DJc6c9xtVqK/',
      embedUrl: 'https://www.instagram.com/reel/DJc6c9xtVqK/embed'
    },
    {
      id: 'DJae8scN3me',
      url: 'https://www.instagram.com/reel/DJae8scN3me/',
      embedUrl: 'https://www.instagram.com/reel/DJae8scN3me/embed'
    },
    {
      id: 'DJXgb7BPeEm',
      url: 'https://www.instagram.com/reel/DJXgb7BPeEm/',
      embedUrl: 'https://www.instagram.com/reel/DJXgb7BPeEm/embed'
    },
    {
      id: 'DJXfAgsPRh1',
      url: 'https://www.instagram.com/reel/DJXfAgsPRh1/',
      embedUrl: 'https://www.instagram.com/reel/DJXfAgsPRh1/embed'
    },
    {
      id: 'DJXdY91vTNg',
      url: 'https://www.instagram.com/reel/DJXdY91vTNg/',
      embedUrl: 'https://www.instagram.com/reel/DJXdY91vTNg/embed'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {instagramVideos.map((video, index) => (
              <div key={video.id} className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-4 border border-yellow-400/20">
